...
#. set
   ...
   - the simulation time to 30 minutes, and
   - possibly a seed number
#. include the output parameter ``MVEL`` defined as the depth- and phase-averaged wave-induced velocity vector (averaged over the last 20 minutes of simulation)
...
.. tip::
   ...
   Access the commands directly through this `page <https://swash.sourceforge.io/online_doc/swashuse/swashuse.html#Q1-1-133>`_.
...
It is also a good idea to study `this section of the manual <https://swash.sourceforge.io/online_doc/swashuse/swashuse.html#x1-420005>`_
